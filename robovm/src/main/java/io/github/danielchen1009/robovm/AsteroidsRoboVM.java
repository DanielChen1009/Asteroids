package io.github.danielchen1009.robovm;
...
public class AsteroidsRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, AsteroidsRoboVM.class);
    pool.close();
  }
}
